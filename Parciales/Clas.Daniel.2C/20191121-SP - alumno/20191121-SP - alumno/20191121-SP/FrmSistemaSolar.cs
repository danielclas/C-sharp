...
namespace _20191121_SP
{
    public partial class FrmSistemaSolar : Form
    {
        ...
        private void FrmSistemaSolar_Load(object sender, EventArgs e)
        {
            ...
            {
                // Leo mis planetas del archivo XML
            ...
            this.Text = "string".EstadoSimulacion(false) + " - Daniel Clas ";
        ...
        private void btnSimular_Click(object sender, EventArgs e)
        {
            if(this.animaciones.Count == 0)
            {
                ...
                foreach (Planeta p in this.planetas)
                {
                    ...
                    this.animaciones.Add(t);
                    this.animaciones.Last().Start();
                }
                this.btnSimular.Text = "Detener";
                this.Text = "string".EstadoSimulacion(true) + " - Daniel Clas ";
            }
            else
            {
        ...
        {
            // Cancelar hilos
            foreach (Thread t in this.animaciones)
            {
                if (t.IsAlive)
                {
                    t.Abort();
