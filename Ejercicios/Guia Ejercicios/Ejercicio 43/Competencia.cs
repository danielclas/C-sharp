...
namespace Ejercicio_43
{
  class Competencia
  {
    ...
    //b.La excepción CompetenciaNoDisponibleExcepcion será lanzada dentro de == de
    //Competencia y Vehiculo con el mensaje "El vehículo no corresponde a la competencia",
    //capturada dentro del operador +y vuelta a lanzar como una nueva excepción con el
    //mensaje "Competencia incorrecta".Utilizar innerExcepcion para almacenar la excepción
    //original.
    public static bool operator ==(Competencia c, VehiculoDeCarrera a)
    {
      bool rtn = false;
